...
:::info
Course Survey: [https://aka.ms/dp800survey](https://aka.ms/dp800survey)
:::

## Course Materials
[Course DP-800T00-A (English)](https://learn.microsoft.com/en-us/training/courses/dp-800t00)

[Course DP-800T00-A (正體中文)](https://learn.microsoft.com/zh-tw/training/courses/dp-800t00)

[Course DP-800T00-A (简体中文)](https://learn.microsoft.com/zh-cn/training/courses/dp-800t00)

## Infos
[ESI Labs Portal](https://aka.ms/esilab)
...
[WINDOW (Transact-SQL)](https://learn.microsoft.com/en-us/sql/t-sql/queries/select-window-transact-sql?view=sql-server-ver17)
...
[Vector search and vector indexes in SQL Server](https://learn.microsoft.com/en-us/sql/sql-server/ai/vectors?view=sql-server-ver17)

[AI Functions (Transact-SQL)](https://learn.microsoft.com/en-us/sql/t-sql/functions/ai-functions-transact-sql?view=sql-server-ver17)
...
[DP-800 Exam Checklist](https://aka.ms/dp800/prepare)

[Get Certified SQL+AI (DP-800): Design and Develop SQL Solutions Like a Pro (APAC)](https://aiskillsnavigator.microsoft.com/explore/search/video-3eb16f73b0c44ef19131e3ce9dba00730b8fd2671cc247d232597b646a7c1aa0)

[Get Certified DP-800: Secure, Optimize, & Ship SQL+AI Solutions (APAC)](https://aiskillsnavigator.microsoft.com/explore/search/video-882356e6a8a0b65dab069a4d1f5b8ce719c5d1de57ac3ff68ea2ac7ed8a0a43f)
